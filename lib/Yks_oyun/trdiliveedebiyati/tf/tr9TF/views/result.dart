...
class TrvEde9Result extends StatefulWidget {
  ...
  @override
  _TrvEde9ResultState createState() => _TrvEde9ResultState();
}

class _TrvEde9ResultState extends State<TrvEde9Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde9HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
