...
class TrvEde13Result extends StatefulWidget {
  ...
  @override
  _TrvEde13ResultState createState() => _TrvEde13ResultState();
}

class _TrvEde13ResultState extends State<TrvEde13Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde13HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
