...
class TrvEde6Result extends StatefulWidget {
  ...
  @override
  _TrvEde6ResultState createState() => _TrvEde6ResultState();
}

class _TrvEde6ResultState extends State<TrvEde6Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde6HomePage()));
              },
              child: Container(
                padding:
