...
class TrvEde5Result extends StatefulWidget {
  ...
  @override
  _TrvEde5ResultState createState() => _TrvEde5ResultState();
}

class _TrvEde5ResultState extends State<TrvEde5Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => TrvEde5HomePage()));
              },
              child: Container(
                padding:
