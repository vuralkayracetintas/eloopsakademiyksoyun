...
import 'package:yksoyun_23_06_2022/Yks_oyun/trdiliveedebiyati/tf/tr8TF/views/homepage.dart';

class TrvEde8Result extends StatefulWidget {
  ...
  @override
  _TrvEde8ResultState createState() => _TrvEde8ResultState();
}

class _TrvEde8ResultState extends State<TrvEde8Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde8HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
