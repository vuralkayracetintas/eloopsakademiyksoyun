...
class TrvEde12Result extends StatefulWidget {
  ...
  @override
  _TrvEde12ResultState createState() => _TrvEde12ResultState();
}

class _TrvEde12ResultState extends State<TrvEde12Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde12HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
