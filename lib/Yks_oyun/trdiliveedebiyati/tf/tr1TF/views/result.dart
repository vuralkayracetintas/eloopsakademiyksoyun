...
class TrvEde1Result extends StatefulWidget {
  ...
  @override
  _TrvEde1ResultState createState() => _TrvEde1ResultState();
}

class _TrvEde1ResultState extends State<TrvEde1Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde1HomePage()));
              },
              child: Container(
                padding:
