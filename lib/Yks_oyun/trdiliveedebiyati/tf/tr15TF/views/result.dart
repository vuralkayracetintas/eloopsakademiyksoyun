...
import 'package:yksoyun_23_06_2022/Yks_oyun/trdiliveedebiyati/tf/tr15TF/views/homepage.dart';

class TrvEde15Result extends StatefulWidget {
  ...
  @override
  _TrvEde15ResultState createState() => _TrvEde15ResultState();
}

class _TrvEde15ResultState extends State<TrvEde15Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde15HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
