...
class TrvEde2Result extends StatefulWidget {
  ...
  @override
  _TrvEde2ResultState createState() => _TrvEde2ResultState();
}

class _TrvEde2ResultState extends State<TrvEde2Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde2HomePage()));
              },
              child: Container(
                padding:
