...
class TrvEde7Result extends StatefulWidget {
  ...
  @override
  _TrvEde7ResultState createState() => _TrvEde7ResultState();
}

class _TrvEde7ResultState extends State<TrvEde7Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrvEde7HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
