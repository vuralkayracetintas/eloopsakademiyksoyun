...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b2tf/views/homepage.dart';

class Bt2TFResult extends StatefulWidget {
  ...
  @override
  _Bt2TFResultState createState() => _Bt2TFResultState();
}

class _Bt2TFResultState extends State<Bt2TFResult> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Bt2TFHomePage()));
              },
              child: Container(
                padding:
