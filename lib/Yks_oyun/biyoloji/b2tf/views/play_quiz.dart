...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b2tf/views/result.dart';
import '../../b2tf/data/data.dart';

class Bt2TFPlayQuiz extends StatefulWidget {
  const Bt2TFPlayQuiz({Key? key}) : super(key: key);

  @override
  _Bt2TFPlayQuizState createState() => _Bt2TFPlayQuizState();
}

class _Bt2TFPlayQuizState extends State<Bt2TFPlayQuiz>
