...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b1tf/views/homepage.dart';

class Bt1TFResult extends StatefulWidget {
 ...
 Key? key,
  ...
  @override
  _Bt1TFResultState createState() => _Bt1TFResultState();
}

class _Bt1TFResultState extends State<Bt1TFResult> {
  String greeting = "";
  @override
  void initState() {
    super.initState();
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Bt1TFHomePage()));
              },
              child: Container(
                padding:
