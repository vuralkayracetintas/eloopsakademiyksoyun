...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b7SST/views/homepage.dart';

class Bt7TFResult extends StatefulWidget {
 ...
 Key? key,
  ...
  @override
  _Bt7TFResultState createState() => _Bt7TFResultState();
}

class _Bt7TFResultState extends State<Bt7TFResult> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => Bt7TFHomePage()));
              },
              child: Container(
                padding:
