...
class Bt10TFResult extends StatefulWidget {
  ...
  @override
  _Bt10TFResultState createState() => _Bt10TFResultState();
}

class _Bt10TFResultState extends State<Bt10TFResult> {
  String greeting = "";
  @override
  void initState() {
    super.initState();
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => Bt10TFHomePage()));
              },
              child: Container(
                padding:
