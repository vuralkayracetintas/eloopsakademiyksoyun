...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b4tf/views/homepage.dart';

class Bt4TFResult extends StatefulWidget {
 ...
 Key? key,
  ...
  @override
  _Bt4TFResultState createState() => _Bt4TFResultState();
}

class _Bt4TFResultState extends State<Bt4TFResult> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Bt4TFHomePage()));
              },
              child: Container(
                padding:
