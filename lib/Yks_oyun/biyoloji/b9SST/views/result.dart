...
class Bt9TFResult extends StatefulWidget {
  ...
  @override
  _Bt9TFResultState createState() => _Bt9TFResultState();
}

class _Bt9TFResultState extends State<Bt9TFResult> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Bt9TFHomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
