...
class Tr11Result extends StatefulWidget {
  ...
  @override
  _Tr11ResultState createState() => _Tr11ResultState();
}

class _Tr11ResultState extends State<Tr11Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr11HomePage()));
              },
              child: Container(
                padding:
