...
class Tr16Result extends StatefulWidget {
  ...
  @override
  _Tr16ResultState createState() => _Tr16ResultState();
}

class _Tr16ResultState extends State<Tr16Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr16HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
