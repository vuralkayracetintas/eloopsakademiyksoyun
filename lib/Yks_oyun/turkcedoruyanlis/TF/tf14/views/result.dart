...
import 'package:yksoyun_23_06_2022/Yks_oyun/turkcedoruyanlis/TF/tf14/views/homepage.dart';

class Tr13Result extends StatefulWidget {
  ...
  @override
  _Tr13ResultState createState() => _Tr13ResultState();
}

class _Tr13ResultState extends State<Tr13Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr13HomePage()));
              },
              child: Container(
                padding:
