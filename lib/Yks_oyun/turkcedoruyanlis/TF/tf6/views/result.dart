...
class Tr5Result extends StatefulWidget {
  ...
  @override
  _Tr5ResultState createState() => _Tr5ResultState();
}

class _Tr5ResultState extends State<Tr5Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr5HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
