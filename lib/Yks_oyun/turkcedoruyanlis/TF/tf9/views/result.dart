...
class Tr8Result extends StatefulWidget {
  ...
  @override
  _Tr8ResultState createState() => _Tr8ResultState();
}

class _Tr8ResultState extends State<Tr8Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr8HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
