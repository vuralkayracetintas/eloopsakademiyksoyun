...
class Tr6Result extends StatefulWidget {
  ...
  @override
  _Tr6ResultState createState() => _Tr6ResultState();
}

class _Tr6ResultState extends State<Tr6Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr6HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
