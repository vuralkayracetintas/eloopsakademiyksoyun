...
class Tr10Result extends StatefulWidget {
  ...
  @override
  _Tr10ResultState createState() => _Tr10ResultState();
}

class _Tr10ResultState extends State<Tr10Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr10HomePage()));
              },
              child: Container(
                padding:
