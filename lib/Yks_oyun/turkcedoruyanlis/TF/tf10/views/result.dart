...
class Tr9Result extends StatefulWidget {
  ...
  @override
  _Tr9ResultState createState() => _Tr9ResultState();
}

class _Tr9ResultState extends State<Tr9Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr9HomePage()));
              },
              child: Container(
                padding:
