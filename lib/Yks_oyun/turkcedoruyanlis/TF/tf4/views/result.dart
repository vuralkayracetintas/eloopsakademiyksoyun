...
class Tr3Result extends StatefulWidget {
  ...
  @override
  _Tr3ResultState createState() => _Tr3ResultState();
}

class _Tr3ResultState extends State<Tr3Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr3HomePage()));
              },
              child: Container(
                padding:
