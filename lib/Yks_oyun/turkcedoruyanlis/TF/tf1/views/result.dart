...
class TrResult extends StatefulWidget {
  ...
  @override
  _TrResultState createState() => _TrResultState();
}

class _TrResultState extends State<TrResult> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TrHomePage()));
              },
              child: Container(
                padding:
