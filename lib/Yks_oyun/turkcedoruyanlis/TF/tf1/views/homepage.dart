...
import 'package:yksoyun_23_06_2022/Yks_oyun/turkcedoruyanlis/TF/tf1/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class TrHomePage extends StatefulWidget {
  const TrHomePage({Key? key}) : super(key: key);

  @override
  _TrHomePageState createState() => _TrHomePageState();
}
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => TrPlayQuiz()));
              },
              child: const Text(
                "Başla ",
