...
class Tr15Result extends StatefulWidget {
  ...
  @override
  _Tr15ResultState createState() => _Tr15ResultState();
}

class _Tr15ResultState extends State<Tr15Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr15HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
