...
class Tr7Result extends StatefulWidget {
  ...
  @override
  _Tr7ResultState createState() => _Tr7ResultState();
}

class _Tr7ResultState extends State<Tr7Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr7HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
