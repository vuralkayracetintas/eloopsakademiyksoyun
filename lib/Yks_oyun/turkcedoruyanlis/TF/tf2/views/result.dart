...
class Tr1Result extends StatefulWidget {
  ...
  @override
  _Tr1ResultState createState() => _Tr1ResultState();
}

class _Tr1ResultState extends State<Tr1Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr1HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
