...
class Tr2Result extends StatefulWidget {
  ...
  @override
  _Tr2ResultState createState() => _Tr2ResultState();
}

class _Tr2ResultState extends State<Tr2Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr2HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
