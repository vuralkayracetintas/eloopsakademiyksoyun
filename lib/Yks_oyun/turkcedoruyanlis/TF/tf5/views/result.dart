...
class Tr4Result extends StatefulWidget {
  ...
  @override
  _Tr4ResultState createState() => _Tr4ResultState();
}

class _Tr4ResultState extends State<Tr4Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Tr4HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
