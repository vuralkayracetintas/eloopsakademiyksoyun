...
class ing2MyHomePage extends StatefulWidget {
  const ing2MyHomePage({Key? key}) : super(key: key);

  @override
  _ing2MyHomePageState createState() => _ing2MyHomePageState();
}

class _ing2MyHomePageState extends State<ing2MyHomePage> {
  ...
  Future addToDatabaseFromAssets() async {
    ...
    final imagePaths = manifestMap.keys
        .where((element) => element.contains('ing/ing2/'))
