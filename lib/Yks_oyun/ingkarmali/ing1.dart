...
class ing1MyHomePage extends StatefulWidget {
  const ing1MyHomePage({
    Key? key,
  }) : super(key: key);

  @override
  _ing1MyHomePageState createState() => _ing1MyHomePageState();
}

class _ing1MyHomePageState extends State<ing1MyHomePage> {
  ...
  Future addToDatabaseFromAssets() async {
    ...
    final imagePaths = manifestMap.keys
        .where((element) => element.contains('ing/ing1/'))
