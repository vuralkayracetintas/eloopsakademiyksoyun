...
class m8Result extends StatefulWidget {
  ...
  @override
  _m8ResultState createState() => _m8ResultState();
}

class _m8ResultState extends State<m8Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m8HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
