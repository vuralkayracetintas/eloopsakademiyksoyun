...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m8/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m8HomePage extends StatefulWidget {
  const m8HomePage({Key? key}) : super(key: key);

  @override
  _m8HomePageState createState() => _m8HomePageState();
}
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m8PlayQuiz()));
              },
              child: const Text(
                "Başla ",
