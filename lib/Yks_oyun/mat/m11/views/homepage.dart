...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m11/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m11HomePage extends StatefulWidget {
  const m11HomePage({Key? key}) : super(key: key);

  @override
  _m11HomePageState createState() => _m11HomePageState();
}

class _m11HomePageState extends State<m11HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m11PlayQuiz()));
              },
              child: const Text(
                "Başla ",
