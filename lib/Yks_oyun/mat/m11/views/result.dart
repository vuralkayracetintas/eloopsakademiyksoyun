...
class m11Result extends StatefulWidget {
  ...
  @override
  _m11ResultState createState() => _m11ResultState();
}

class _m11ResultState extends State<m11Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m11HomePage()));
              },
              child: Container(
                padding:
