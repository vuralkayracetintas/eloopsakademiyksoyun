...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m3/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m3HomePage extends StatefulWidget {
  const m3HomePage({Key? key}) : super(key: key);

  @override
  _m3HomePageState createState() => _m3HomePageState();
}

class _m3HomePageState extends State<m3HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m3PlayQuiz()));
              },
              child: const Text(
                "Başla ",
