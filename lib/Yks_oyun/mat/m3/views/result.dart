...
class m3Result extends StatefulWidget {
  ...
  @override
  _m3ResultState createState() => _m3ResultState();
}

class _m3ResultState extends State<m3Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m3HomePage()));
              },
              child: Container(
                padding:
