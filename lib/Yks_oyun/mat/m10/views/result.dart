...
class m10Result extends StatefulWidget {
  ...
  @override
  _m10ResultState createState() => _m10ResultState();
}

class _m10ResultState extends State<m10Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => m10HomePage()));
              },
              child: Container(
                padding:
