...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m10/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m10HomePage extends StatefulWidget {
  const m10HomePage({Key? key}) : super(key: key);

  @override
  _m10HomePageState createState() => _m10HomePageState();
}

class _m10HomePageState extends State<m10HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m10PlayQuiz()));
              },
              child: const Text(
                "Başla ",
