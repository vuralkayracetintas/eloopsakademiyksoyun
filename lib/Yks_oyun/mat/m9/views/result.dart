...
class m9Result extends StatefulWidget {
  ...
  @override
  _m9ResultState createState() => _m9ResultState();
}

class _m9ResultState extends State<m9Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m9HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
