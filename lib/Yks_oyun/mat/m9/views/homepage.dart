...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m9/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m9HomePage extends StatefulWidget {
  const m9HomePage({Key? key}) : super(key: key);

  @override
  _m9HomePageState createState() => _m9HomePageState();
}

class _m9HomePageState extends State<m9HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m9PlayQuiz()));
              },
              child: const Text(
                "Başla ",
