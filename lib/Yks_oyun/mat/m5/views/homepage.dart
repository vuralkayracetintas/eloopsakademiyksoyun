...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m5/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m5HomePage extends StatefulWidget {
  const m5HomePage({Key? key}) : super(key: key);

  @override
  _m5HomePageState createState() => _m5HomePageState();
}

class _m5HomePageState extends State<m5HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m5PlayQuiz()));
              },
              child: const Text(
                "Başla ",
