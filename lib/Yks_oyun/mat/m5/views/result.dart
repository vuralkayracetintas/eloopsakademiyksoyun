...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m5/views/homepage.dart';

class m5Result extends StatefulWidget {
  ...
  @override
  _m5ResultState createState() => _m5ResultState();
}

class _m5ResultState extends State<m5Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m5HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
