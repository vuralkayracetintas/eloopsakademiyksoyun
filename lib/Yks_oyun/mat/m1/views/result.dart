...
class m1Result extends StatefulWidget {
  ...
  @override
  _m1ResultState createState() => _m1ResultState();
}

class _m1ResultState extends State<m1Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m1HomePage()));
              },
              child: Container(
                padding:
