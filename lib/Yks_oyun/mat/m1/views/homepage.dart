...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m1/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m1HomePage extends StatefulWidget {
  const m1HomePage({Key? key}) : super(key: key);

  @override
  _m1HomePageState createState() => _m1HomePageState();
}

class _m1HomePageState extends State<m1HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m1PlayQuiz()));
              },
              child: const Text(
                "Başla ",
