...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m4/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m4HomePage extends StatefulWidget {
  const m4HomePage({Key? key}) : super(key: key);

  @override
  _m4HomePageState createState() => _m4HomePageState();
}

class _m4HomePageState extends State<m4HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m4PlayQuiz()));
              },
              child: const Text(
                "Başla ",
