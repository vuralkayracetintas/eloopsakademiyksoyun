...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m4/views/homepage.dart';

class m4Result extends StatefulWidget {
  ...
  @override
  _m4ResultState createState() => _m4ResultState();
}

class _m4ResultState extends State<m4Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => m4HomePage()));
              },
              child: Container(
                padding:
