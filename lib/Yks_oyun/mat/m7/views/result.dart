...
class m7Result extends StatefulWidget {
  ...
  @override
  _m7ResultState createState() => _m7ResultState();
}

class _m7ResultState extends State<m7Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m7HomePage()));
              },
              child: Container(
                padding:
