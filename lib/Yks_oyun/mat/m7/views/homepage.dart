...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m7/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m7HomePage extends StatefulWidget {
  const m7HomePage({Key? key}) : super(key: key);

  @override
  _m7HomePageState createState() => _m7HomePageState();
}

class _m7HomePageState extends State<m7HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m7PlayQuiz()));
              },
              child: const Text(
                "Başla ",
