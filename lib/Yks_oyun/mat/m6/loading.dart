...
class SplashScreen26 extends StatefulWidget {
  const SplashScreen26({Key? key}) : super(key: key);

  @override
  _SplashScreen26State createState() => _SplashScreen26State();
}

class _SplashScreen26State extends State<SplashScreen26> {
  @override
  void initState() {
    ...
    Timer(const Duration(milliseconds: 280), () {
      Navigator.of(context)
          .pushReplacement(MaterialPageRoute(builder: (_) => const m6HomePage()));
    });
  }
