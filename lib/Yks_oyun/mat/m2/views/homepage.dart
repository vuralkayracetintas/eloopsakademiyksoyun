...
import 'package:yksoyun_23_06_2022/Yks_oyun/mat/m2/views/play_quiz.dart';
import 'package:yksoyun_23_06_2022/customText.dart';

class m2HomePage extends StatefulWidget {
  const m2HomePage({Key? key}) : super(key: key);

  @override
  _m2HomePageState createState() => _m2HomePageState();
}

class _m2HomePageState extends State<m2HomePage> {
  @override
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const m2PlayQuiz()));
              },
              child: const Text(
                "Başla ",
