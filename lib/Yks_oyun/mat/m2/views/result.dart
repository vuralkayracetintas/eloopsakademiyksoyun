...
class m2Result extends StatefulWidget {
  ...
  @override
  _m2ResultState createState() => _m2ResultState();
}

class _m2ResultState extends State<m2Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => m2HomePage()));
              },
              child: Container(
                padding:
