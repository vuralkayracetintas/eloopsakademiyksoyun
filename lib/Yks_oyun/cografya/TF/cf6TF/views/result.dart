...
import 'package:yksoyun_23_06_2022/Yks_oyun/cografya/TF/cf6TF/views/homepage.dart';

class cf6Result extends StatefulWidget {
  ...
  @override
  _cf6ResultState createState() => _cf6ResultState();
}

class _cf6ResultState extends State<cf6Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => cf6HomePage()));
              },
              child: Container(
                padding:
