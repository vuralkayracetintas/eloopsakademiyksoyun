...
class cf2Result extends StatefulWidget {
  ...
  @override
  _cf2ResultState createState() => _cf2ResultState();
}

class _cf2ResultState extends State<cf2Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const cf2HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
