...
import 'package:yksoyun_23_06_2022/Yks_oyun/cografya/TF/cf9TF/views/homepage.dart';

class cf9Result extends StatefulWidget {
  ...
  @override
  _cf9ResultState createState() => _cf9ResultState();
}

class _cf9ResultState extends State<cf9Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => cf9HomePage()));
              },
              child: Container(
                padding:
