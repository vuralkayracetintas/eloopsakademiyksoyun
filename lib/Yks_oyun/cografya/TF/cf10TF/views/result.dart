...
class cf10Result extends StatefulWidget {
  ...
  @override
  _cf10ResultState createState() => _cf10ResultState();
}

class _cf10ResultState extends State<cf10Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const cf10HomePage()));
              },
              child: Container(
                padding:
