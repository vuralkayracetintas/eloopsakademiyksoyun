...
import 'package:yksoyun_23_06_2022/Yks_oyun/cografya/TF/cf3TF/views/homepage.dart';

class cf3Result extends StatefulWidget {
  ...
  @override
  _cf3ResultState createState() => _cf3ResultState();
}

class _cf3ResultState extends State<cf3Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const cf3HomePage()));
              },
              child: const Text(
                'Yeniden',
                style: TextStyle(
