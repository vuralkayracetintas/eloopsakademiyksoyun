...
import 'package:yksoyun_23_06_2022/Yks_oyun/cografya/TF/cf4TF/views/homepage.dart';

class cf4Result extends StatefulWidget {
  ...
  @override
  _cf4ResultState createState() => _cf4ResultState();
}

class _cf4ResultState extends State<cf4Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => cf4HomePage()));
              },
              child: Container(
                padding:
