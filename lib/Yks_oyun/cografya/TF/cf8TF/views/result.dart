...
import 'package:yksoyun_23_06_2022/Yks_oyun/cografya/TF/cf8TF/views/homepage.dart';

class cf8Result extends StatefulWidget {
  ...
  @override
  _cf8ResultState createState() => _cf8ResultState();
}

class _cf8ResultState extends State<cf8Result> {
  String greeting = "";
  @override
  void initState() {
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(context,
                    MaterialPageRoute(builder: (context) => cf8HomePage()));
              },
              child: Container(
                padding:
