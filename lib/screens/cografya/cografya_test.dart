...
import 'cografya_test_butonlar.dart';

const int maxFailedLoadAttempts = 3;

class cografya extends StatefulWidget {
  const cografya({Key? key}) : super(key: key);

  @override
  State<cografya> createState() => _cografyaState();
}

class _cografyaState extends State<cografya> {
