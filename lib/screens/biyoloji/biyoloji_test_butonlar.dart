...
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b10SST/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b1tf/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b2tf/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b3tf/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b4tf/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b5tf/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b6SST/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b7SST/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b8SST/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/biyoloji/b9SST/loading.dart';
import 'package:yksoyun_23_06_2022/Yks_oyun/dogrucevaplar/load/loading.dart';
...
class sinav extends StatefulWidget {
  ...
  const sinav({Key? key, required this.k, required this.isDonek})
      : super(key: key);
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      ...
                      width: 43,
                      decoration: BoxDecoration(
                        color: widget.isDonek ? kBlueColor : Colors.white,
...
class k1 extends StatefulWidget {
  ...
  const k1({Key? key, required this.k, required this.isDonek})
      : super(key: key);
...
class k2 extends StatefulWidget {
  ...
  const k2({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k3 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k3({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SplashScreenbiyo()));
              },
              child: Padding(
                padding: const EdgeInsets.all(16.0),
                child: Row(
...
class k4 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k4({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k5 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k5({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k6 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k6({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k7 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k7({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k8 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k8({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k9 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k9({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
...
class k10 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k10({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SplashScreen7()));
              },
              child: Padding(
                padding: const EdgeInsets.all(16.0),
                child: Row(
...
class k11 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k11({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SplashScreen8()));
              },
              child: Padding(
                padding: const EdgeInsets.all(16.0),
                child: Row(
...
class k12 extends StatefulWidget {
  final int ka;
  final bool isDonek;
  const k12({Key? key, required this.ka, required this.isDonek})
      : super(key: key);
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SplashScreen9()));
              },
              child: Padding(
                padding: const EdgeInsets.all(16.0),
                child: Row(
